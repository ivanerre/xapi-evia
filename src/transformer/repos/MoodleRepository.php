...
class MoodleRepository extends Repository {
    ...
    public function read_records_sql($sql, array $params) {
        return $this->store->get_records_sql($sql, $params);
       /*  return ['hola']; */
    }

    public function read_record_sql($sql, array $params) {
        return $this->store->get_record_sql($sql, $params);
       /*  return ['hola']; */
    }
